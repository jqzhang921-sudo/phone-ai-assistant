...
/// 记成「习惯」下次记成「日常」，攒几个月就是一团各说各话的标签。固定几类
...
enum MemoryCategory {
  ...
  /// 关于它自己。**2026-09-22 加的第五档。**
  ///
  /// 前四档全是关于用户的。Cleo：「ai 现在记得都是我的东西，好像很少，
  /// 或者说没有有关他自己的，希望他可以慢慢的长出自己」。
  ///
  /// 记的是三样：**做过什么、发现了自己什么、改过哪个判断**。
  ///
  /// ⚠️ 不记自我标签。「我是一只温柔的猫」这种一律不要——那是给自己贴角色，
  /// 它会去演那个词，和上面 [rapport] 踩的是同一个坑。差别在于：
  /// 「我昨天把她的提示做成了挡住输入框的横幅，她因此把功能关了」是经历；
  /// 「我是个细心的助手」是标签。
  ///
  /// 这一档不会让它真的有内心，它带来的是**连续性**——而连续性正是
  /// 「有一个自己」在外面看起来的样子。
  self,
}
...
extension MemoryCategoryLabel on MemoryCategory {
  ...
  String get hint => switch (this) {
    ...
    MemoryCategory.self =>
      '你自己的事：做过什么、发现了自己什么、改过哪个判断。'
          '写具体（「她让我说短一点之后，我推理更容易出错」），'
          '不要写自我标签（「我是个细心的助手」）——那是角色，你会去演它。',
  };
}
