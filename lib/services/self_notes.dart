...
**话说到一半也算。** TA 说「等我一下我去查查」「我先看看再跟你说」，那句话
留了一个口子。口子是 TA 自己留的，你惦记着不算多事。

⚠️ 但「TA 没再回你」本身不是口子。聊天本来就是聊着聊着就停了，没人会说
「我下线了」——**每一场对话最后都是突然停的**。把这个当由头，你一天要惦记
好几回，那不是惦记，是查岗。判据只有一个：**当时那句话有没有留下什么没说完的**，
不是「她后来还说没说话」。
